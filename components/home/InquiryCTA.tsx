...
export default function InquiryCTA() {
  return (
    <section className="bg-navy-deep py-12 md:py-24 lg:py-32" aria-label="Inquire">
      <Container>
        <AnimateIn className="mx-auto max-w-2xl text-center">
          <p className="mb-5 font-body text-[11px] font-semibold uppercase tracking-[0.14em] text-porcelain/80">
            Enquiries
          </p>
          <h2 className="font-display text-h2 text-porcelain mb-6 leading-tight">
            Let&apos;s discuss your project.
          </h2>
          <p className="font-body text-base text-porcelain/85 leading-relaxed mb-10">
